          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
            ...
            >
              ...
              <motion.p 
                ...
                variants={itemVariants}
              >
                StudyMateAI adapts to your learning style, providing personalized support that evolves with your needs. Experience motivation that feels human, with AI that understands you.
              </motion.p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center max-w-3xl mx-auto mb-20">
              ...
              >
                ...
                <span className="text-sm font-medium text-white">Why Choose StudyMateAI?</span>
              </motion.div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center max-w-3xl mx-auto mb-20">
              ...
              <motion.p
                ...
                viewport={{ once: true }}
              >
                Set up StudyMateAI in minutes and experience personalized learning immediately.
              </motion.p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description: "Begin your sessions and watch as StudyMateAI adapts to your unique learning style and needs.",
      ...
      >
        <div className="container mx-auto px-6">
          ...
          <div className="border-t border-white/10 mt-12 pt-8 text-center">
            <p className="text-white/80 text-sm">© {new Date().getFullYear()} StudyMateAI. All rights reserved.</p>
